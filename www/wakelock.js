 ...
 */
WakeLock.prototype.acquire = function(successCallback,failureCallback, runLockScreen) {
    if( typeof runLockScreen === "undefined" ) runLockScreen = false;

    cordova.exec(successCallback, failureCallback, 'WakeLock', 'acquire', [runLockScreen]);
}
 ...
 */
WakeLock.prototype.release = function(successCallback,failureCallback) {
    cordova.exec(successCallback, failureCallback, 'WakeLock', 'release', []);
}
 ...
 * @param errorCallback
 */
WakeLock.prototype.setReleaseOnPause = function(enabled, successCallback, failureCallback) {
    cordova.exec(successCallback, failureCallback, 'WakeLock', 'setReleaseOnPause', [enabled]);
}
 ...
 * @param errorCallback function to be called when there was a problem with acquiring the wake-lock
 */
WakeLock.prototype.dim = function(successCallback,failureCallback) {
    cordova.exec(successCallback, failureCallback, 'WakeLock', 'acquire', [true]);
}
